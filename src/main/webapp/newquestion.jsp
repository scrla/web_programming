    ...
    <style>
        ...
        input[disabled], textarea[disabled] {
		    ...
		    border: 1px solid #ccc; /* 기본 테두리 유지 */
		 	cursor: not-allowed; /* 비활성화된 상태를 나타내는 포인터 */
		}
    ...
    <div class="container">
        <form action="newquestion" method="post">
            <div class="form-group">
                ...
                <input type="text" id="club-name" placeholder="CAPS" value="${dongari.title}" required/>
            </div>
            <div class="form-group">
                <label for="question-title">질문 제목</label>
                <input type="text" id="question-title" name="title" value="${question.title}" required/>
            </div>
            <div class="form-group">
                <label for="question-content">질문 내용</label>
                <textarea id="question-content" name="body" required>${question.body}</textarea>
            </div>
